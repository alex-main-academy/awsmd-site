    ...
    <section className="about">
        ...
        {isDesktop && (
          ...
          >
            {videos.map((_, i) => (
              ...
              >
                <span className="about__progress-segment-title">{videos[i].title}</span>
      ...
      <div className="about__content">
        <h2 className="about__title">
          ...
          <span className="about__title--decorative">team of experts</span>, we create memorable and
          emotional websites, digital experiences, and native apps.
        </h2>
        <h3 className="about__subtitle">{videos[index].title}</h3>
        <p className="about__description">
          Many years of expertise in mobile development allow us to design architecture and create
          bespoke native applications for Apple iOS and Google Android.
        </p>
        ...
        {!isDesktop && (
          <>
            <div className="about__progress-state">
              <span className="about__progress-title">{videos[index].title}</span>
              <div className="about__progress-video">
                <span className="about__progress-video-current">{index + 1}</span>
                <span className="about__progress-video-all">-0{videos.length}</span>
              </div>
            </div>
            <div className="about__progress">
              <div className="about__progress-bar" style={{ width: `${progress}%` }} />
            </div>
          </>
        )}
      </div>
